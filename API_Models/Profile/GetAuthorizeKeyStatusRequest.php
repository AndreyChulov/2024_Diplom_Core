...
#[OA\QueryParameter(
    parameter: "GetAuthorizeKeyStatusRequest_LoginParameter",
    name: "Login",
...
#[OA\QueryParameter(
    parameter: "GetAuthorizeKeyStatusRequest_KeyParameter",
    name: "Key",
    description: <<<DESCRIPTION
...
class GetAuthorizeKeyStatusRequest extends BaseRequest
{
